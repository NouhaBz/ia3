...
public class main {
    ...
    public static void main(String[] args) {
        ...
        String cases []={"free" , "blok" , "wall","water ","grass","sand"};
      ...
      while(H!=0){
                                    ...
                                    if(grid[ib][jb].equals(cases[4])){
                                                      bettery=bettery-2;
                                                  }else{
                                                      if(grid[ib][jb].equals(cases[5])){
                                                         bettery=bettery-3;
                                                      }else{
                                                         if(grid[ib][jb].equals(cases[3])){
                                                      bettery=bettery-4;
                                                         } else{
                                                              bettery--;
                                                              }
...
//########################################   h3  ########################################################
 ...
 //########################################       4 demonstruction            ##########################################################                            
        ...
        if(bettery==0){
            System.out.println("\n THE BETTERY IS 0% wait for charging : \n");
            for(int i =0;i<b;i++){
                System.out.print("|");
            }
